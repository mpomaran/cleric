...
SUITE(file_buffer_tests)
{
    TEST(OpenCloseTest1)
    {
        ...
        auto open = OPEN_W<char>(__U("OpenCloseTest1.txt"));
    ...
    {
        utility::string_t fname = __U("OpenForReadDoesntCreateFile1.txt");
    ...
    {
        utility::string_t fname = __U("OpenForReadDoesntCreateFile2.txt");
    ...
    {
        auto open = OPEN_W<char>(__U("WriteSingleCharTest1.txt"));
        auto stream = open.get();
    ...
    {
        auto open = OPEN_W<wchar_t>(__U("WriteSingleCharTest1w.txt"));
        auto stream = open.get();
    ...
    {
        auto open = OPEN_W<char>(__U("WriteBufferTest1.txt"));
        auto stream = open.get();
    ...
    {
        auto open = OPEN_W<wchar_t>(__U("WriteBufferTest1w.txt"));
        auto stream = open.get();
    ...
    {
        auto open = OPEN_W<char>(__U("WriteBufferAndSyncTest1.txt"));
        auto stream = open.get();
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_bumpc1.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("SequentialReadWrite.txt");
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_bumpcw.txt");
        fill_file_w(fname);
    ...
    TEST(ReadSingleChar_bumpc2)
    {
        ...
        utility::string_t fname = __U("ReadSingleChar_bumpc2.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_bumpc3.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_nextc.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_nextcw.txt");
        fill_file_w(fname);
    ...
    {
        // Test that seeking works.
        utility::string_t fname = __U("ReadSingleChar_ungetc.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_getc1.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_getc2.txt");
        fill_file(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_getc1w.txt");
        fill_file_w(fname);
    ...
    {
        utility::string_t fname = __U("ReadSingleChar_getc2w.txt");
        fill_file_w(fname);
    ...
    {
        // Test that seeking works.
        utility::string_t fname = __U("ReadBuffer1.txt");
        fill_file(fname);
    ...
    {
        // Test that seeking works.
        utility::string_t fname = __U("ReadBuffer1w.txt");
        fill_file_w(fname);
    ...
    TEST(ReadBuffer2)
    {
        ...
        utility::string_t fname = __U("ReadBuffer2.txt");
        fill_file(fname, 30);
    ...
    TEST(SeekEnd1)
    {
        utility::string_t fname = __U("SeekEnd1.txt");
        fill_file(fname, 30);
    ...
    TEST(IsEOFTest)
    {
        utility::string_t fname = __U("IsEOFTest.txt");
        fill_file(fname, 30);
    ...
    TEST(CloseWithException)
    {
        ...
        auto streambuf = OPEN_W<char>(__U("CloseExceptionTest.txt")).get();
        ...
        streambuf = OPEN_R<char>(__U("CloseExceptionTest.txt")).get();
    ...
    TEST(inout_regression_test)
    {
        ...
        concurrency::streams::streambuf<char> file_buf =
            OPEN<char>(__U("inout_regression_test.txt"), std::ios_base::in | std::ios_base::out).get();
    ...
    {
        utility::string_t fname = __U("seek_read_regression_test.txt");
        fill_file(fname, 100);
    ...
    TEST(file_size)
    {
        utility::string_t fname = __U("file_size.txt");
        fill_file(fname, 100);
    ...
    TEST(file_size_w)
    {
        utility::string_t fname = __U("file_size_w.txt");
    ...
    TEST(file_with_one_byte_size)
    {
        ...
        concurrency::streams::streambuf<char> file_buf = OPEN<char>(__U("one_byte_file.txt"), std::ios_base::out).get();
        file_buf.putc('a').wait();
        file_buf.close().wait();

        // Try to read from file with a 2 byte character.
        concurrency::streams::basic_istream<wchar_t> inFile(OPEN<wchar_t>(__U("one_byte_file.txt"), std::ios::in).get());
    ...
    {
        // Create a file with one byte.
        string_t filename = __U("read_one_byte_at_4G.txt");
    ...
    TEST(write_one_byte_at_4G)
    {
        ...
        string_t filename = __U("write_one_byte_at_4G.txt");
    ...
    {
        concurrency::streams::streambuf<char> file_buf =
            OPEN<char>(__U("alloc_not_supported.txt"), std::ios::out | std::ios::in).get();
    ...
    {
        auto file_buf1 = OPEN<char>(__U("read_acquire_not_supported1.txt"), std::ios::out | std::ios::in).get();
        auto file_buf2 = OPEN<char>(__U("read_acquire_not_supported2.txt"), std::ios::out | std::ios::in).get();
    ...
    TEST(winrt_filestream_close)
    {
        ...
        auto t = OPEN_W<uint8_t>(__U("file.txt")).then([this, str](concurrency::streams::ostream stream) {
