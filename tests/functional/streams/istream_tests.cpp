...
SUITE(istream_tests)
{
    ...
    TEST(fstream_read_1)
    {
        utility::string_t fname = __U("fstream_read_1.txt");
        fill_file(fname);
    ...
    TEST(fstream_read_2)
    {
        utility::string_t fname = __U("fstream_read_2.txt");
        fill_file(fname);
    ...
    TEST(fstream_read_4)
    {
        ...
        utility::string_t fname = __U("fstream_read_4.txt");
        fill_file(fname, 2);
    ...
    TEST(fstream_read_5)
    {
        ...
        utility::string_t fname = __U("fstream_read_5.txt");
    ...
    TEST(fstream_readline_1)
    {
        ...
        utility::string_t fname = __U("fstream_readline_1.txt");
        fill_file_with_lines(fname, "\n", 2);
    ...
    TEST(fstream_readline_2)
    {
        ...
        utility::string_t fname = __U("fstream_readline_2.txt");
        fill_file_with_lines(fname, "\r\n", 2);
    ...
    TEST(fstream_read_to_end_1)
    {
        ...
        utility::string_t fname = __U("fstream_read_to_end_1.txt");
    ...
    TEST(fstream_read_to_end_2)
    {
        ...
        utility::string_t fname = __U("fstream_read_to_end_2.txt");
        fill_file(fname);
    ...
    TEST(fstream_read_to_end_3)
    {
        ...
        utility::string_t fname = __U("fstream_read_to_end_3.txt");
        fill_file(fname, 1);
