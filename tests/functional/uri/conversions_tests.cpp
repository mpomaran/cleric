...
SUITE(conversions_tests)
{
    ...
    {
        utility::string_t encoded = uri::encode_uri(__U("http://testname.com/%%?qstring"));
        uri u1(__U("http://testname.com/%25%25?qstring"));
    ...
    {
        utility::string_t encoded = uri::encode_uri(__U("http://testname.com/%%?qstring"));
        uri u(__U("http://testname.com/%25%25?qstring"));
    ...
    {
        uri u;
        VERIFY_ARE_EQUAL(__U("/"), u.to_string());
    }
