...
SUITE(json_numbers_tests)
{
    TEST(numbers)
    {
        json::value num = json::value::parse(__U("-22"));
        VERIFY_ARE_EQUAL(-22, num.as_double());
        VERIFY_ARE_EQUAL(-22, num.as_integer());

        num = json::value::parse(__U("-1.45E2"));
        VERIFY_IS_TRUE(num.is_number());

        num = json::value::parse(__U("-1.45E+1"));
        VERIFY_IS_TRUE(num.is_number());

        num = json::value::parse(__U("-1.45E-10"));
        VERIFY_IS_TRUE(num.is_number());

        num = json::value::parse(__U("1e01"));
        VERIFY_IS_TRUE(num.is_number());
    }
    ...
    TEST(compare_numbers)
    {
        ...
        VERIFY_ARE_EQUAL(json::value(3.14), json::value::parse(__U("3.14")));
        VERIFY_ARE_EQUAL(json::value(uint64_t(1234)), json::value::parse(__U("1234")));
        VERIFY_ARE_EQUAL(json::value(uint32_t(10)), json::value::parse(__U("10")));
        ...
        VERIFY_ARE_EQUAL(json::value(int32_t(10)), json::value::parse(__U("10")));
        VERIFY_ARE_EQUAL(json::value(int64_t(1234)), json::value::parse(__U("1234")));
        ...
        VERIFY_ARE_EQUAL(json::value(int32_t(0)), json::value::parse(__U("-0")));
        VERIFY_ARE_EQUAL(json::value(int64_t(0)), json::value::parse(__U("-0")));
        VERIFY_ARE_EQUAL(json::value::parse(__U("0")), json::value::parse(__U("-0")));
    }
